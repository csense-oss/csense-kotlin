...
//
//public inline fun <T> List<T>.findFirstSeriesOrNull(
//    isItemInSeries: Function1<T, Boolean>,
//    startIndex: Int = 0
//): Series<T>? {
//
//    val indexOfSeries = indexOfSeriesOrNull(startIndex)
//
//    var haveFoundASeries = false
//    forEachIndexed { index, item ->
//        val isSeries = isItemInSeries(item)
//        seriesStart = minOf(seriesStart, index)
//
//        val haveFoundEndOfSeries = haveFoundASeries && !isSeries
//        if (haveFoundEndOfSeries) {
//
//        }
//        haveFoundASeries = isSeries
//    }
//    return null
//}
//
//public inline fun <T> List<T>.indexOfSeriesStartOrNull(
//    isItemInSeries: Function1<T, Boolean>,
//    searchFromIndex: Int = 0
//): Int? {
//
//     this.indexOfFirstOrNull(isItemInSeries)
//
//    for (i in searchFromIndex until size) {
//        val item = getOrNull(i) ?: return null
//        if (isItemInSeries(item)) {
//            return i
//        }
//    }
//    return null
