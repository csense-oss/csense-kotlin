 ...
 * see [L.warning]
 */
public inline fun LLogger.warning(cls: Class<*>, message: String, exception: Throwable? = null) {
    warning(cls.simpleName, message, exception)
}
 ...
 * see [L.warning]
 */
public inline fun LLogger.warning(kClass: KClass<*>, message: String, exception: Throwable? = null) {
    warning(kClass.java, message, exception)
}
...
public inline fun LLogger.warningLazy(
    ...
    warningLazy(cls.simpleName, message, exception)
}
...
public inline fun LLogger.warningLazy(
    ...
    warningLazy(klz.java, message, exception)
}
